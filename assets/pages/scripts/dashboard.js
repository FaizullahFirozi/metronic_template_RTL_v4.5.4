var Dashboard = function() {
    ...
    return {
        ...
        initDashboardDaterange: function() {
            ...
            $('#lends-report-range').daterangepicker({
                "ranges": {
                    'Today': [moment(), moment()],
                ...
                $('#lends-report-range span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
            });

            $('#lends-report-range span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
            $('#lends-report-range').show();
        },
